...
NB = 28
NBF = NB - 2
a_static=DeFixedInt(NB,NBF,'S','round','saturate') # Definicion completa de un objeto de la clase respetando posicion de los parametros
b_static=DeFixedInt(NB,NBF,'S','round','saturate') # Definicion completa de un objeto de la clase respetando posicion de los parametros
c_static=DeFixedInt(2*NB,2*NBF,'S','round','saturate') # Definicion completa de un objeto de la clase respetando posicion de los parametros
a_static.value = 0.00001
b_static.value = 0.00001

c_static.value = a_static.fValue*b_static.fValue


print(c_static.fValue, a_static.fValue, b_static.fValue)